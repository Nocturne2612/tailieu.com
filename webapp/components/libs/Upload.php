...
class Upload {
    ...
    function init() {
        ...
        $this->image_watermark  = ROOT_PATH.DS.'images/logo_test.png';
        $this->image_watermark_x = 10;
        $this->image_watermark_y = 100;
    ...
    function upload($file, $lang = 'vn_VN') {
        ...
        $this->translation['file_error'] = 'CÃ³ lá»—i file. HÃ£y thá»­ láº¡i láº§n ná»¯a.';
        $this->translation['local_file_missing'] = 'ThÆ° má»¥c file khÃ´ng tá»“n táº¡i.';
        $this->translation['local_file_not_readable'] = 'ThÆ° má»¥c file khÃ´ng ghi Ä‘Æ°á»£c.';
        $this->translation['uploaded_too_big_ini'] = 'Lá»—i upload file (dung lÆ°á»£ng file upload vÆ°á»£t quÃ¡ chá»‰ Ä‘á»‹nh trong php.ini).';
        $this->translation['uploaded_too_big_html'] = 'Lá»—i upload file (dung lÆ°á»£ng file upload vÆ°á»£t quÃ¡ chá»‰ Ä‘á»‹nh trong html form).';
        $this->translation['uploaded_partial'] = 'Lá»—i upload file (file upload chá»‰ upload lÃªn Ä‘Æ°á»£c má»™t pháº§n).';
        $this->translation['uploaded_missing'] = 'Lá»—i upload file (khÃ´ng upload Ä‘Æ°á»£c file).';
        $this->translation['uploaded_unknown'] = 'Lá»—i upload file (khÃ´ng hiá»ƒu lá»—i code).';
        $this->translation['try_again'] = 'Lá»—i upload file. HÃ£y thá»­ láº¡i láº§n ná»¯a.';
        $this->translation['file_too_big'] = 'File quÃ¡ lá»›n.';
        $this->translation['no_mime'] = 'KhÃ´ng thá»ƒ tÃ¬m tháº¥y kiá»ƒu MIME.';
        $this->translation['incorrect_file'] = 'Sai kiá»ƒu file.';
        $this->translation['image_too_wide'] = 'áº¢nh quÃ¡ rá»™ng.';
        $this->translation['image_too_narrow'] = 'áº¢nh quÃ¡ háº¹p.';
        $this->translation['image_too_high'] = 'áº¢nh quÃ¡ cao.';
        $this->translation['image_too_short'] = 'áº¢nh quÃ¡ ngáº¯n.';
        $this->translation['ratio_too_high'] = 'Tá»· lá»‡ áº£nh quÃ¡ cao (áº£nh quÃ¡ rá»™ng).';
        $this->translation['ratio_too_low'] = 'Tá»· lá»‡ áº£nh quÃ¡ tháº¥p (áº£nh quÃ¡ cao).';
        $this->translation['too_many_pixels'] = 'áº¢nh cÃ³ quÃ¡ nhiá»u pixels.';
        $this->translation['not_enough_pixels'] = 'áº¢nh khÃ´ng Ä‘á»§ pixels.';
        $this->translation['file_not_uploaded'] = 'File khÃ´ng upload Ä‘Æ°á»£c. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['already_exists'] = '%s Ä‘Ã£ tá»“n táº¡i. HÃ£y Ä‘á»•i láº¡i tÃªn file.';
        $this->translation['temp_file_missing'] = 'Sai Ä‘Æ°á»ng dáº«n thÆ° má»¥c temp. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['source_missing'] = 'Sai táº­p tin nguá»“n táº£i lÃªn. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['destination_dir'] = 'KhÃ´ng thá»ƒ táº¡o thÆ° má»¥c Ä‘Ã­ch. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['destination_dir_missing'] = 'ThÆ° má»¥c Ä‘Ã­ch khÃ´ng tá»“n táº¡i. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['destination_path_not_dir'] = 'ÄÆ°á»ng dáº«n Ä‘Ã­ch khÃ´ng pháº£i lÃ  thÆ° má»¥c. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['destination_dir_write'] = 'ThÆ° má»¥c Ä‘Ã­ch khÃ´ng thá»ƒ ghi Ä‘Æ°á»£c. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['destination_path_write'] = 'ÄÆ°á»ng dáº«n Ä‘Ã­ch khÃ´ng ghi Ä‘Æ°á»£c. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['temp_file'] = 'KhÃ´ng thá»ƒ táº¡o Ä‘Æ°á»£c file táº¡m. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['source_not_readable'] = 'File nguá»“n khÃ´ng Ä‘á»c Ä‘Æ°á»£c. KhÃ´ng thá»ƒ thá»±c hiá»‡n tiáº¿p.';
        $this->translation['no_create_support'] = 'KhÃ´ng há»— trá»£ táº¡o tá»« %s .';
        $this->translation['create_error'] = 'Lá»—i trong khi táº¡o áº£nh %s tá»« nguá»“n.';
        $this->translation['source_invalid'] = 'KhÃ´ng thá»ƒ Ä‘á»c áº£nh nguá»“n. KhÃ´ng pháº£i lÃ  áº£nh ?.';
        $this->translation['gd_missing'] = 'GD dÆ°á»ng nhÆ° khÃ´ng cÃ³.';
        $this->translation['watermark_no_create_support'] = 'KhÃ´ng há»— trá»£ táº¡o tá»« %s , khÃ´ng thá»ƒ Ä‘á»c watermark.';
        $this->translation['watermark_create_error'] = 'KhÃ´ng há»— trá»£ Ä‘á»c %s , khÃ´ng thá»ƒ táº¡o watermark.';
        $this->translation['watermark_invalid'] = 'KhÃ´ng biáº¿t Ä‘á»‹nh dáº¡ng áº£nh, khÃ´ng thá»ƒ Ä‘á»c watermark.';
        $this->translation['file_create'] = 'KhÃ´ng há»— trá»£ táº¡o %s .';
        $this->translation['no_conversion_type'] = 'KhÃ´ng chuyá»ƒn Ä‘á»•i kiá»ƒu Ä‘Ã£ Ä‘á»‹nh nghÄ©a.';
        $this->translation['copy_failed'] = 'Lá»—i khi copy file trÃªn server. copy() lá»—i.';
        $this->translation['reading_failed'] = 'Lá»—i khi Ä‘á»c file.';

        // determines the language
        $this->lang = $lang;
        /*  if ($this->lang != 'vn_VN' && file_exists(dirname(__FILE__).'/lang') && file_exists(dirname(__FILE__).'/lang/class.upload.' . $lang . '.php')) {
          $translation = null;
        ...
        if (empty($this->log)) {
            ...
            if (function_exists('ini_get_all')) {
                $inis = ini_get_all();
                $open_basedir = (array_key_exists('open_basedir', $inis) && array_key_exists('local_value', $inis['open_basedir']) && !
                        empty($inis['open_basedir']['local_value'])) ? $inis['open_basedir']['local_value'] : false;
            } else {
                $open_basedir = false;
            }
            $gd = $this->gdversion() ? $this->gdversion(true) : 'GD not present';
            $supported = trim((in_array('png', $this->image_supported) ? 'png' : '') . ' ' . (in_array('jpg', $this->
                            image_supported) ? 'jpg' : '') . ' ' . (in_array('gif', $this->image_supported) ? 'gif' : '') . ' ' . (in_array('bmp', $this->
                            image_supported) ? 'bmp' : ''));
            ...
            $this->log .= '-&nbsp;open_basedir            : ' . (!empty($open_basedir) ? $open_basedir : 'no restriction') .
                    '<br />';
            $this->log .= '-&nbsp;upload_max_filesize     : ' . $this->file_max_size_raw . ' (' . $this->file_max_size .
                    ' bytes)<br />';
            ...
            if (empty($file)) {
                ...
                if ($this->uploaded) {
                    ...
                    if (is_array($extension) && sizeof($extension) > 0) {
                        ...
                        $this->file_src_name_body = substr($this->file_src_name, 0, ((strlen($this->file_src_name) - strlen($this->
                                        file_src_name_ext))) - 1);
                    } else {
                        $this->file_src_name_ext = '';
        ...
        if ($this->uploaded) {
            ...
            if (!$this->file_src_mime || !is_string($this->file_src_mime) || empty($this->file_src_mime) || strpos($this->
                            file_src_mime, '/') === false) {
                if ($this->mime_fileinfo) {
                    ...
                    if (function_exists('finfo_open')) {
                        ...
                        if (is_resource($f)) {
                            ...
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;MIME type detected as ' . $this->file_src_mime .
                ...
                if ($this->mime_getimagesize) {
                    ...
                    if (is_array($info) && array_key_exists('mime', $info)) {
                        ...
                        if (empty($this->file_src_mime)) {
                            ...
                            $this->file_src_mime = ($mime == IMAGETYPE_GIF ? 'image/gif' : ($mime == IMAGETYPE_JPEG ? 'image/jpeg' : ($mime ==
                                                    IMAGETYPE_PNG ? 'image/png' : ($mime == IMAGETYPE_BMP ? 'image/bmp' : null))));
                        }
                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;MIME type detected as ' . $this->file_src_mime .
            ...
            if (!empty($mime_from_browser) && !$this->file_src_mime || !is_string($this->file_src_mime) || empty($this->
                            file_src_mime)) {
            ...
            if ($this->file_src_mime == 'application/octet-stream' || !$this->file_src_mime || !is_string($this->file_src_mime) ||
                    empty($this->file_src_mime) || strpos($this->file_src_mime, '/') === false) {
                ...
                if (array_key_exists($this->file_src_name_ext, $this->mime_types))
                    $this->file_src_mime = $this->mime_types[$this->
                            file_src_name_ext];
                if ($this->file_src_mime == 'application/octet-stream') {
            ...
            if ($this->file_src_mime && is_string($this->file_src_mime) && !empty($this->file_src_mime) && array_key_exists($this->
                            file_src_mime, $this->image_supported)) {
            ...
            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;file_src_size         : ' . $this->file_src_size . ' (max= ' . $this->
                    file_max_size . ')<br />';
    ...
    function getsize($size) {
        ...
        $size = (int) substr_replace($size ,"", -1);
        switch ($last) {
            case 'g':
                $size *= 1024;
            case 'm':
    ...
    function imagecopymergealpha(&$dst_im, &$src_im, $dst_x, $dst_y, $src_x, $src_y, $src_w, $src_h, $pct = 0) {
        ...
        for ($y = $src_y; $y < $src_h; $y++) {
            for ($x = $src_x; $x < $src_w; $x++) {
                ...
                if ($x + $dst_x >= 0 && $x + $dst_x < $dst_w && $x + $src_x >= 0 && $x + $src_x < $src_w && $y + $dst_y >= 0 && $y + $dst_y <
                        $dst_h && $y + $src_y >= 0 && $y + $src_y < $src_h) {
    ...
    function process($server_path = null) {
        ...
        if ($this->image_text_background_opacity == 100)
            $this->image_text_background_opacity = $this->
        ...
        if ($this->processed) {
            ...
            if ($this->no_script) {
                ...
                if ((((substr($this->file_src_mime, 0, 5) == 'text/' && $this->file_src_mime != 'text/rtf') || strpos($this->
                                file_src_mime, 'javascript') !== false) && (substr($file_src_name, -4) != '.txt')) || preg_match('/\.(php|pl|py|cgi|asp|js)$/i', $this->file_src_name) || $this->file_force_extension && empty($file_src_name_ext)) {
        ...
        if ($this->processed) {
            ...
            $image_manipulation = ($this->file_is_image && ($this->image_resize || $this->image_convert != '' || is_numeric($this->
                            image_brightness) || is_numeric($this->image_contrast) || is_numeric($this->image_opacity) || is_numeric($this->
                            image_threshold) || !empty($this->image_tint_color) || !empty($this->image_overlay_color) || $this->image_unsharp || !
                    empty($this->image_text) || $this->image_greyscale || $this->image_negative || !empty($this->image_watermark) ||
                    is_numeric($this->image_rotate) || is_numeric($this->jpeg_size) || !empty($this->image_flip) || !empty($this->
                            image_crop) || !empty($this->image_precrop) || !empty($this->image_border) || !empty($this->image_border_transparent) ||
                    $this->image_frame > 0 || $this->image_bevel > 0 || $this->image_reflection_height));
        ...
        if ($this->processed) {
            ...
            if (!$return_mode) {
                ...
                if ($this->processed && !($f = @fopen($this->file_dst_path . $hash . (!empty($this->file_dst_name_ext) ? '.' . $this->
                                        file_dst_name_ext : ''), 'a+'))) {
                ...
                if (!$this->no_upload_check && empty($this->file_src_temp) && !@file_exists($this->file_src_pathname)) {
                    ...
                    $hash = md5($this->file_dst_name_body . rand(1, 1000));
                    if (move_uploaded_file($this->file_src_pathname, $this->file_dst_path . $hash . (!empty($this->file_dst_name_ext) ? '.' .
                                            $this->file_dst_name_ext : ''))) {
                        $this->file_src_pathname = $this->file_dst_path . $hash . (!empty($this->file_dst_name_ext) ? '.' . $this->
                                        file_dst_name_ext : '');
        ...
        if ($this->processed) {
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_convert != 'png' && $this->image_convert != 'gif' && !empty($this->image_default_color) && empty($this->
                    ...
                    if ($this->image_resize) {
                        ...
                        if ($this->image_ratio || $this->image_ratio_crop || $this->image_ratio_fill || $this->image_ratio_no_zoom_in || $this->
                                image_ratio_no_zoom_out) {
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;check x/y sizes<br />';
                            if ((!$this->image_ratio_no_zoom_in && !$this->image_ratio_no_zoom_out) || ($this->image_ratio_no_zoom_in && ($this->
                                    image_src_x > $this->image_x || $this->image_src_y > $this->image_y)) || ($this->image_ratio_no_zoom_out && $this->
                                    image_src_x < $this->image_x && $this->image_src_y < $this->image_y)) {
                                $this->image_dst_x = $this->image_x;
                                $this->image_dst_y = $this->image_y;
                                if ($this->image_ratio_crop) {
                                    ...
                                    if (($this->image_src_x / $this->image_x) > ($this->image_src_y / $this->image_y)) {
                                        ...
                                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;ratio_crop_x         : ' . $ratio_crop['x'] . ' (' . $ratio_crop['l'] . ';' . $ratio_crop['r'] .
                                                ')<br />';
                                        ...
                                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;ratio_crop_y         : ' . $ratio_crop['y'] . ' (' . $ratio_crop['t'] . ';' . $ratio_crop['b'] .
                                                ')<br />';
                                        if (is_null($this->image_crop))
                                            $this->image_crop = array(
                                                0,
                                ...
                                if ($this->image_ratio_fill) {
                                    ...
                                    if (($this->image_src_x / $this->image_x) < ($this->image_src_y / $this->image_y)) {
                                        ...
                                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;ratio_fill_x         : ' . $ratio_crop['x'] . ' (' . $ratio_crop['l'] . ';' . $ratio_crop['r'] .
                                                ')<br />';
                                        if (is_null($this->image_crop))
                                            $this->image_crop = array(
                                                0,
                                        ...
                                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;ratio_fill_y         : ' . $ratio_crop['y'] . ' (' . $ratio_crop['t'] . ';' . $ratio_crop['b'] .
                                                ')<br />';
                                        if (is_null($this->image_crop))
                                            $this->image_crop = array(
                                                0,
                        ...
                        if ($gd_version >= 2) {
                            $res = imagecopyresampled($tmp, $image_src, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, $this->image_src_x, $this->
                                    image_src_y);
                        } else {
                            $res = imagecopyresized($tmp, $image_src, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, $this->image_src_x, $this->
                                    image_src_y);
                        }
                    ...
                    // unsharp mask
                    if ($gd_version >= 2 && $this->image_unsharp && is_numeric($this->image_unsharp_amount) && is_numeric($this->
                                    image_unsharp_radius) && is_numeric($this->image_unsharp_threshold)) {
                            ...
                            if ($this->image_unsharp_threshold > 0) {
                                for ($x = 0; $x < $this->image_dst_x - 1; $x++) {
                                    for ($y = 0; $y < $this->image_dst_y; $y++) {
                                        ...
                                        $p_new['red'] = (abs($p_orig['red'] - $p_blur['red']) >= $this->image_unsharp_threshold) ? max(0, min(255, ($this->
                                                                image_unsharp_amount * ($p_orig['red'] - $p_blur['red'])) + $p_orig['red'])) : $p_orig['red'];
                                        $p_new['green'] = (abs($p_orig['green'] - $p_blur['green']) >= $this->image_unsharp_threshold) ? max(0, min(255, ($this->
                                                                image_unsharp_amount * ($p_orig['green'] - $p_blur['green'])) + $p_orig['green'])) : $p_orig['green'];
                                        $p_new['blue'] = (abs($p_orig['blue'] - $p_blur['blue']) >= $this->image_unsharp_threshold) ? max(0, min(255, ($this->
                                                                image_unsharp_amount * ($p_orig['blue'] - $p_blur['blue'])) + $p_orig['blue'])) : $p_orig['blue'];
                    ...
                    // add color overlay
                    if ($gd_version >= 2 && (is_numeric($this->image_overlay_opacity) && $this->image_overlay_opacity > 0 && !empty($this->
                                    image_overlay_color))) {
                        ...
                        $this->imagecopymergealpha($image_dst, $filter, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, $this->
                                image_overlay_opacity);
                        imagedestroy($filter);
                    }

                    // add brightness, contrast and tint, turns to greyscale and inverts colors
                    if ($gd_version >= 2 && ($this->image_negative || $this->image_greyscale || is_numeric($this->image_threshold) ||
                            is_numeric($this->image_brightness) || is_numeric($this->image_contrast) || !empty($this->image_tint_color))) {
                        $this->log .= '- apply tint, light, contrast correction, negative, greyscale and threshold<br />';
                        if (!empty($this->image_tint_color))
                            list($tint_red, $tint_green, $tint_blue) = $this->getcolors($this->
                                    image_tint_color);
                    ...
                    if ($this->image_watermark != '' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_checked) {
                            ...
                            if ((!$this->image_watermark_no_zoom_out && ($watermark_dst_width > $this->image_dst_x || $watermark_dst_height > $this->
                                    image_dst_y)) || (!$this->image_watermark_no_zoom_in && $watermark_dst_width < $this->image_dst_x && $watermark_dst_height <
                                    $this->image_dst_y)) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark resized from ' . $watermark_src_width . 'x' . $watermark_src_height .
                                        ' to ' . $watermark_dst_width . 'x' . $watermark_dst_height . '<br />';
                            }
                    ...
                    if (!empty($this->image_text)) {
                        ...
                        if (!is_numeric($this->image_text_font) && strlen($this->image_text_font) > 4 && substr(strtolower($this->
                                                image_text_font), -4) == '.gdf') {
                        ...
                        if (!empty($this->image_text_background)) {
                            ...
                            if ($gd_version >= 2 && (is_numeric($this->image_text_background_opacity)) && $this->image_text_background_opacity >= 0 &&
                                    $this->image_text_background_opacity <= 100) {
                                ...
                                $this->imagecopymergealpha($image_dst, $filter, $text_x, $text_y, 0, 0, $text_width, $text_height, $this->
                        ...
                        if ($gd_version >= 2 && (is_numeric($this->image_text_opacity)) && $this->image_text_opacity >= 0 && $this->
                                image_text_opacity <= 100) {
                            if ($t_width < 0)
                                $t_width = 0;
                            if ($t_height < 0)
                                $t_height = 0;
                            ...
                            foreach ($text as $k => $v) {
                                if ($this->image_text_direction == 'v') {
                                    imagestringup($filter, $this->image_text_font, $k * ($line_width + ($k > 0 && $k < (sizeof($text)) ? $this->
                                                    image_text_line_spacing : 0)), $text_height - (2 * $this->image_text_padding_y) - ($this->image_text_alignment == 'l' ?
                                                    0 : (($t_height - strlen($v) * $char_width) / ($this->image_text_alignment == 'r' ? 1 : 2))), $v, $text_color);
                                } else {
                                    imagestring($filter, $this->image_text_font, ($this->image_text_alignment == 'l' ? 0 : (($t_width - strlen($v) * $char_width) /
                                                    ($this->image_text_alignment == 'r' ? 1 : 2))), $k * ($line_height + ($k > 0 && $k < (sizeof($text)) ? $this->
                                                    image_text_line_spacing : 0)), $v, $text_color);
                                }
                            }
                            ...
                            foreach ($text as $k => $v) {
                                if ($this->image_text_direction == 'v') {
                                    imagestringup($image_dst, $this->image_text_font, $text_x + $k * ($line_width + ($k > 0 && $k < (sizeof($text)) ? $this->
                                                    image_text_line_spacing : 0)), $text_y + $text_height - (2 * $this->image_text_padding_y) - ($this->
                                            image_text_alignment == 'l' ? 0 : (($t_height - strlen($v) * $char_width) / ($this->image_text_alignment == 'r' ? 1 : 2))), $v, $text_color);
                                } else {
                                    imagestring($image_dst, $this->image_text_font, $text_x + ($this->image_text_alignment == 'l' ? 0 : (($t_width - strlen
                                                            ($v) * $char_width) / ($this->image_text_alignment == 'r' ? 1 : 2))), $text_y + $k * ($line_height + ($k > 0 && $k < (sizeof
                                                    ($text)) ? $this->image_text_line_spacing : 0)), $v, $text_color);
                                }
                            }
                        }
                    }
                    ...
                    if ($this->image_reflection_height) {
                        ...
                        if (strpos($image_reflection_height, '%') > 0)
                            $image_reflection_height = $this->image_dst_y * (str_replace('%', '', $image_reflection_height /
                                            100));
                        ...
                        $tmp = $this->imagecreatenew($this->image_dst_x, $this->image_dst_y + $image_reflection_height + $this->
                                image_reflection_space, true);
                        $transparency = $this->image_reflection_opacity;

                        // copy the original image
                        imagecopy($tmp, $image_dst, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y + ($this->image_reflection_space < 0 ? $this->
                                        image_reflection_space : 0));
                        ...
                        if ($image_reflection_height + $this->image_reflection_space > 0) {
                            ...
                            imagefill($tmp, round($this->image_dst_x / 2), $this->image_dst_y + $image_reflection_height + $this->
                                    image_reflection_space - 1, $fill);
                        }
                        ...
                        for ($y = 0; $y < $image_reflection_height; $y++) {
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                ...
                                $pixel_o = imagecolorsforindex($image_dst, imagecolorat($image_dst, $x, $this->image_dst_y - $y - 1 + ($this->
                                                image_reflection_space < 0 ? $this->image_reflection_space : 0)));
                    ...
                    if (is_numeric($this->jpeg_size) && $this->jpeg_size > 0 && ($this->image_convert == 'jpeg' || $this->image_convert ==
                            'jpg')) {
    ...
    public static function UploadNoThumb($file, $dir, $name = '', $w = '') { // $size : r?ng ?nh to $w
        $handle = new Upload($file);
        $handle->file_max_size = 1024 * 1024 * 10; // 10MB
    ...
    public static function UploadOne($file, $dir, $dirT, $w, $x, $y = '', $name = '') { // $w : rộng ảnh to $x rộng ,$y cao
        $handle = new Upload($file);
        $handle->file_max_size = 1024 * 1024 * 4; // 4MB
        $handle->jpeg_quality = 95;
        if ($name != '')
            $handle->file_new_name_body = $name;
        if ($handle->uploaded) {
    ...
    public static function UploadMutil($files, $dir, $dirT, $size, $x, $y = '', $name = '',$check = '') {
        $nameImage = array();
        if($check) {
            if(!Validation::_checkImages($files)) {
                return false;
            }
        }
        ...
        foreach ($filess as $key => $file) {
            ...
            $handle = new upload($file);
            $handle->file_max_size = 1024 * 1024 * 10; // 4MB
            $handle->jpeg_quality = 95;
            if ($name != '')
                $handle->file_new_name_body = $key . '-' . $name;
            if ($handle->uploaded) {
                if ($handle->image_src_x > $size) {
                    $handle->image_resize = true;
                    $handle->image_x = $size;
                    $handle->image_ratio_y = true;
                }
                ...
                if ($handle->processed) {
                    ...
                    echo '"Lỗi file thứ' . ($key + 1) . ': ' . $handle->error . '"';
                    //echo alert('Lỗi file thứ' . ($key + 1) . ': ' . $handle->error, '', 'err');
                }
            }
        }
        $pro = implode('|', $nameImage);
        return $pro;
    }
