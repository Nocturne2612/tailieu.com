...
//        $this->url_api = $url_api;
        ...
        $this->receiver_email = EMAIL_NGANLUONG;
    }
    ...
    function IBCheckout($order_code, $total_amount, $bank_code, $payment_type, $order_description, $tax_amount, $fee_shipping, $discount_amount, $return_url, $cancel_url, $buyer_fullname = '', $buyer_email = '', $buyer_mobile = '', $buyer_address = '', $array_items = array()) {
        $params = array(
            'cur_code' => $this->cur_code,
            'function' => 'SetExpressCheckout',
            'version' => $this->version,
