<div class="icon-searchNav subpageBan ">
    ...
    <div class="res-search js_search w1520">
        ...
        <div class="res-search-input index-search-input">
            <input style="color: #333" type="text" value="{$data.title}" placeholder="Search {$data.title}" data-type="{$data.platforms}" class="js_search-input">
        </div>
...
<div id="v2-subpageBan" class="subpageBan new-subpageBan">
    <div class="w1520 pr">
        ...
        <p style="text-align: center;font-size: 16px; color:#666;"> Có {$output.totalRecord} kết quả</p>
    </div>
</div>
<div id="v2-content">
    <div id="v2-content">
