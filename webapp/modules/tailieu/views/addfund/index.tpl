<div id="content">
                    ...
                    <div class="row bg-tab">
                        <div class="col-xs-12">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="bold active"><a href="javascript:void(0)"
                                        onclick="openCity(event, 'ATM')" rel="nofollow" role="tab" data-toggle="tab"
                                        aria-expanded="true"
                                        style="color: rgb(141, 198, 63); background: rgb(238, 238, 238);">2 - THẺ
                                        ATM</a></li>
                                <li role="presentation" class="bold"><a href="javascript:void(0)" rel="nofollow"
                                        onclick="openCity(event, 'BALANCE')" role="tab" data-toggle="tab"
                                        aria-expanded="false">3 - VÍ NGÂN LƯỢNG</a></li>
                                <li role="presentation" class="bold"><a href="javascript:void(0)" rel="nofollow"
                                        role="tab" onclick="openCity(event, 'PAYPAL')" data-toggle="tab"
                                        aria-expanded="false">4 - PAYPAL</a></li>
                                <li role="presentation" class="bold"><a href="javascript:void(0)" rel="nofollow"
                                        role="tab" data-toggle="tab" onclick="openCity(event, 'TRANSFER')"
                                        aria-expanded="false">5 - CHUYỂN KHOẢN</a></li>
                            </ul>
                        </div>
                    </div>
                    {literal}
    ...
    <script language="javascript">
        var mc_flow = new NGANLUONG.apps.MCFlow({
            trigger: 'btn_deposit',
            url: '{/literal}{$link_checkout}{literal}'
        });
    </script>
    <style>
        ...
        input[type="text"]:not(.txt-search):hover,
