                ...
                <div class="individual-info">
                    ...
                    <div class="individual-share">
                        ...
                        <div class="share-group circle larger">
                            <a href="javascript:;"
                               onclick="Pngtree.BaseFun.Base_OpenWin('https://www.facebook.com/share.php?u={$smarty.const.ROOT_URL}/tailieu/account/member/id/{$data.id}.html?share=2','facebook-share')"
                               data-type="1" class="share-two bg-facebook share-user-btn">
                                <i class="iconfont icon-facebook"></i>
                            </a>
                            <a href="javascript:;"
                               onclick="Pngtree.BaseFun.Base_OpenWin('https://twitter.com/intent/tweet?url={$smarty.const.ROOT_URL}/tailieu/account/member/id/{$data.id}.html?share=1','twitter-share')"
                               data-type="1" class="bg-twitter share-one share-user-btn">
                                <i class="iconfont icon-twitter"></i>
                            </a>
                            <a href="javascript:;"
                               onclick="Pngtree.BaseFun.Base_OpenWin('https://www.pinterest.com/pin/create/button/?url={$smarty.const.ROOT_URL}/tailieu/account/member/id/{$data.id}.html?share=3','pinterest-share')"
