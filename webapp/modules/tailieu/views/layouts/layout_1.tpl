...
<body class="windows" data-platform="windows">
...
<div class="container"><div id="topLink">{$this->widget('TWidgets',['methodName'=>'ex_link'],true)}
<div class="mxh">
...
<div id="container" class="container"> {$this->widget('TWidgets',['methodName'=>'head'],true)}
  ...
  <div id="page" class="categorypage twocolumn clearfix">
    <div id="maincontent" class="clearfix"> {$content} </div>
    <div id="rightsidebar" class="clearfix"> {$this->widget('TWidgets',['methodName'=>'info_account'],true)} 
