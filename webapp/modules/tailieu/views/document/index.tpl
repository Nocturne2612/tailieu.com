        ...
        <div class="fl-r db-rightInfor">
            ...
            <div class="dbr-items">
                <div class="dbr-btnbox clearfix detail-down-click">
                    <a data-down="{$output.id}_DOWNLOAD" rel="nofollow"  {if $check_login} href="{SystemBase::buildUrl('tailieu/download',['id'=>$output.id,'title'=>$output.title])}" class="fl-l btn-free"{else}href="javascript:;" class="fl-l btn-free down-no-login"{/if}>
