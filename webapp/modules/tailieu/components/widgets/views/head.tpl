                ...
                <div class="login-section">
                    <div class="rlg-with-box">
                        ...
                        <div class="share-website clearfix ">
                            ...
                            <a href="{$fb_login}" rel="nofollow" data-type="fb" class="btn-facebook  fl-l">
        ...
        <div class="tkw-registerCont rlg-main">
            ...
            <div class="register-wrap">
                ...
                <div class="register-section">
                    <div class="rlg-with-box">
                        ...
                        <div class="share-website clearfix ">
                            <a href="{SystemBase::buildUrl('tailieu/login/google',[])}" rel="nofollow" data-type="gg"
                                ...
                                <i class="iconfont icon-google"></i>Google</a>
                            <a href="{$fb_login}" rel="nofollow" data-type="fb" class="btn-facebook base-go-login fl-l">
                    ...
                    {CHtml::beginForm('/site/register','post',['enctype' => '','class'=> 'other-account','id' =>
                    ...
                    <input class="ui-input" id="mobile_phone" name="mobile_phone" placeholder="Số điện thoại"
                        type="mobile_phone" data-toggle="popover" autocomplete="off" data-placement="bottom" value="">
...
<div id="v2-head" class="v2-header">
    ...
    <script type="text/javascript">
        function searching() {
            ...
            keyword = keyword.replace(/"/g, '');
            if (parseInt(cate) > 0) {
                location.href = '{/literal}{$smarty.const.ROOT_URL}/{literal}tim-kiem/' + cate + '-' +
                    encodeURIComponent(keyword).replace(/%20/g, '+') + '.html';
            } else {
                location.href = '{/literal}{$smarty.const.ROOT_URL}/{literal}tim-kiem/' + encodeURIComponent(keyword)
                    .replace(/%20/g, '+') + '.html';
            }
            return false;
        }
