        ...
        {foreach $data as $rs}
            <li class="">
                <div class="hover-show">
                    ...
                    <a target="_blank" data-down="{$rs.id}_DOWNLOAD" rel="nofollow" href="/element/down?id=NDc3MzQwMw==&type=1" class="hs-downPng down-jpg-click element-list-click">
        ...
        {foreach $data as $rs}
            ...
            <li class="li-box grid-sizer search_keyword_statis_js" data-id="{$rs.id}">
                <div class="hover-show">
                    ...
                    <a target="_blank" data-down="{$rs.id}_DOWNLOAD" rel="nofollow" href="{SystemBase::buildUrl('tailieu/download',['id'=>$rs.id,'title'=>$rs.title])}" class="hs-downPng down-jpg-click element-list-click">
                        <i class="iconfont icon-xiazai"></i>&nbsp;{$rs.count_down|number_format:2:",":"."|replace:',00':''}
                    </a>
                </div>
                <!-- png -->
